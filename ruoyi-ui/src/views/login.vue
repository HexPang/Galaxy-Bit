<template>
  <div class="login">
    <vue-canvas-nest :config="{color:'50,50,50', count: 88}" :el="'.login'" style="background-color: #999b9e"></vue-canvas-nest>
    <!--    :model="loginForm" :rules="loginRules"-->
    <div class="login-form">
      <h3 class="title">GalaxyBit</h3>
...
<script>
  ...
  export default {
    name: "Login",
    components: {RegisterForm, vueCanvasNest},
    data() {
      return {
        registerForm: {},
        activeTab: "login",
